 ...
 */
export interface QueryAPIDataGrain {
  /**
    ...
    data: [
      {
         ...
         */
        pre?: NodeResource | DeviceResource | SourceResource | FlowResource | SenderResource | ReceiverResource;
        /**
         ...
         */
        post?: NodeResource | DeviceResource | SourceResource | FlowResource | SenderResource | ReceiverResource;
        [k: string]: unknown;
      },
      ...{
        /**
